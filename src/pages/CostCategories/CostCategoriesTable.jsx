...
const CostCategoriesTable = (props) => {
  const {
    headers,
    userRole,
    relodeTable,
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="d-flex" style={{ gap: "20px" }}>
          {["Developer", "Cost-categories-edit"].some((item) =>
            ...
            <div className="shortModalBtn">
              <Suspense fallback="...">
                <CommonModal
                  ...
                  api={`/costCategoryUpdate/${row.id}`}
                  getSpecificDataApi="/costCategoryShow"
          ...
          {["Developer", "Cost-categories-delete"].some((item) =>
            userRole.includes(item)
          ) && (
...
export default CostCategoriesTable;
